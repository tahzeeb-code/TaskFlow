    ...
    <div className="min-h-screen flex items-center justify-center bg-taskflow-bg p-4">
      <Card className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-taskflow-ink">Welcome back</h1>
          <p className="text-taskflow-textSecondary mt-2 text-sm">Sign in to access your workspace</p>
        </div>
        ...
        <p className="text-center text-sm text-taskflow-textSecondary mt-8">
          Don't have an account? <Link to="/register" className="text-taskflow-ink font-medium hover:underline">Create one</Link>
        </p>
      </Card>
    </div>
  );
